<template>
   <main-layout>
      <div class="container flex flex-col justify-start bg-white p-4">
         ...
         <div class="w-full" v-for="(count, index) in NUMBER_OF_ROWS" :key="index">
            <div class="columns relative my-4 grid h-[11rem] grid-cols-4 items-center justify-between bg-brand-gray p-[1.2rem] text-xl font-semibold" v-for="(ride, index) in rideHistory" :key="index">
               <!-- First Column  -->
